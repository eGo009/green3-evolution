...
public class DefendAction extends GameAction{
    ...
    public CommonEntity doAction(Connection connection, Map<String,Object> params){
        ...
        boolean success = getGameManager().defendAnimal(gameId, Integer.valueOf(playerId), Integer.valueOf(predatorId), Integer.valueOf(targetAnimalId), Integer.valueOf(propertyType), connection);
        if (!success){
