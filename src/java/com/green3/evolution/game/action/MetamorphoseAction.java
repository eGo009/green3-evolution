 ...
 */
public class MetamorphoseAction extends GameAction{
    ...
    public CommonEntity doAction(Connection connection, Map<String,Object> params){
        ...
        getGameManager().applyMetamorphose(Integer.valueOf(playerId), Integer.valueOf(animalId), Integer.valueOf(propertyId), connection);
        return null;
    }
}
