 ...
 */
public class GenerateSupplyAction extends GameAction{
    ...
    public CommonEntity doAction(Connection connection, Map<String,Object> params){
        ...
        getGameManager().generateFoodSupply(gameId, connection);
        getGameManager().goToNextStageForGame(gameId, connection);
        return null;
    }
}
