 ...
 */
public class FatburnAction extends GameAction{
    ...
    public CommonEntity doAction(Connection connection, Map<String,Object> params){
        ...
        getGameManager().fatburn(Integer.valueOf(playerId), Integer.valueOf(targetAnimalId), Integer.valueOf(propertyId), connection);
        return null;
    }
}
