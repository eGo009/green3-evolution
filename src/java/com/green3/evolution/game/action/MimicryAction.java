 ...
 */
public class MimicryAction extends GameAction{
    ...
    public CommonEntity doAction(Connection connection, Map<String,Object> params){
        ...
        String mimicId = (String)params.get(GameConstants.PARAM_MIMIC_ANIMAL_ID);
        ...
        boolean success = getGameManager().mimicry(gameId, Integer.valueOf(playerId), Integer.valueOf(animalId), Integer.valueOf(mimicId), Integer.valueOf(predatorId), connection);
        if (!success){
