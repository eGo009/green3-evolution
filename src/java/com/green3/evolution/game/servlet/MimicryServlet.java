...
import com.green3.evolution.game.action.MimicryAction;
 ...
 */
public class MimicryServlet extends GameServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Action action = new MimicryAction();
        ...
        String mimicAnimalIdParam = request.getParameter(GameConstants.PARAM_MIMIC_ANIMAL_ID);
        if (mimicAnimalIdParam == null || "".equals(mimicAnimalIdParam)){
            mimicAnimalIdParam = "-1";
        }
        
        Map<String,Object> params = createParamsMap(request, operationType, playerIdParam, animalIdParam, linkedAnimalIdParam, mimicAnimalIdParam);
    ...
    protected Map<String, Object> createParamsMap(HttpServletRequest request, GameActionType operationType, String playerIdParam, String animalIdParam, String linkedAnimalIdParam, String mimicAnimalIdParam) {
        ...
        params.put(GameConstants.PARAM_MIMIC_ANIMAL_ID, mimicAnimalIdParam);
        return params;
    }
