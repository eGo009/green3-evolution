...
import com.green3.evolution.game.action.SpecializationAction;
 ...
 */
public class SpecializationServlet extends GameServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Action action = new SpecializationAction();
        ...
        Map<String,Object> params = createParamsMap(request, operationType, playerIdParam, animalIdParam);
    ...
    protected Map<String, Object> createParamsMap(HttpServletRequest request, GameActionType operationType, String playerIdParam, String animalIdParam) {
