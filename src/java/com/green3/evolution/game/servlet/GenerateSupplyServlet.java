...
import com.green3.evolution.game.action.GenerateSupplyAction;
import com.green3.evolution.game.action.PassTurnAction;
 ...
 */
public class GenerateSupplyServlet extends GameServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Action action = new GenerateSupplyAction();
        
        Map<String,Object> params = createParamsMap(request, null);
